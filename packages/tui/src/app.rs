...
use crate::data::{DailyUsage, DataLoader, ModelUsage, Source, UsageData};
use crate::settings::Settings;
use crate::themes::{Theme, ThemeName};
use crate::Args;
...
impl App {
    pub fn new(args: Args) -> Result<Self> {
        ...
        let theme_name: ThemeName = args.theme.parse().unwrap_or_else(|_| settings.theme_name());
        ...
        let auto_refresh_interval = if args.refresh > 0 {
        ...
        let data_loader = DataLoader::new(args.sessions_path.map(std::path::PathBuf::from));
