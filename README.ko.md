...
- **멀티 플랫폼 지원** - OpenCode, Claude Code, Codex CLI, Cursor IDE, Gemini CLI, Amp, Droid, OpenClaw 사용량 통합 추적
...
- **키보드 내비게이션**:
  ...
  - `↑/↓`: 목록 탐색
  - `c/n/t`: 비용/이름/토큰별 정렬
  - `1-8`: 소스 토글 (OpenCode/Claude/Codex/Cursor/Gemini/Amp/Droid/OpenClaw)
  - `p`: 9가지 색상 테마 순환
  - `r`: 데이터 새로고침
  - `e`: JSON으로 내보내기
  - `q`: 종료
