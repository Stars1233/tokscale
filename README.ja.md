...
- **キーボードナビゲーション**:
  ...
  - `1-9`: ソーストグル（OpenCode/Claude/Codex/Cursor/Gemini/Amp/Droid/OpenClaw/Pi）
  - `p`: 9色テーマを循環
  - `r`: データ更新
  - `e`: JSONにエクスポート
  - `q`: 終了
...
- **年別フィルタリング**: 年間を移動
- **ソースフィルタリング**: プラットフォーム別フィルター（OpenCode、Claude、Codex、Cursor、Gemini、Amp、Droid、OpenClaw、Pi）
